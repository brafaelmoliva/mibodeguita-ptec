  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-10">
    <div className="bg-white p-6 rounded shadow-md w-96">
      ...
      <input
        ...
        onChange={(e) =>
          setNuevoProducto({ ...nuevoProducto, descripcion_producto: e.target.value })
        }
        className="w-full border mb-2 px-3 py-2 rounded"
      />
      ...
      <input
        ...
        onChange={(e) =>
          setNuevoProducto({ ...nuevoProducto, stock_min: e.target.value })
        }
        className="w-full border mb-2 px-3 py-2 rounded"
      />
        ...
        {["unidad", "kg", "litro"].map((unidad) => (
          <label key={unidad} className="mr-4">
            <input
              ...
              onChange={() =>
                setNuevoProducto({ ...nuevoProducto, unidad_medida: unidad })
              }
            />
            {unidad}
          </label>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-10">
          <div className="bg-white p-6 rounded shadow-md w-96">
            ...
            <input
              ...
              onChange={(e) =>
                setProductoEdit({ ...productoEdit, nombre_producto: e.target.value })
              }
              className="w-full border mb-2 px-3 py-2 rounded"
            />
            <input
              ...
              onChange={(e) =>
                setProductoEdit({ ...productoEdit, descripcion_producto: e.target.value })
              }
              className="w-full border mb-2 px-3 py-2 rounded"
            />
            <select
              ...
              onChange={(e) =>
                setProductoEdit({ ...productoEdit, id_categoria: e.target.value })
              }
            >
              <option value="">Seleccionar categoría</option>
              {categorias.map((cat) => (
            ...
            <select
              ...
              onChange={(e) =>
                setProductoEdit({ ...productoEdit, id_proveedor: e.target.value })
              }
            >
              <option value="">Seleccionar proveedor</option>
             {proveedores.map((prov) => (
  <option key={prov.id_proveedor} value={prov.id_proveedor}>
    {prov.nombre_razon_social}
              ...
              {["unidad", "kg", "litro"].map((unidad) => (
                <label key={unidad} className="mr-4">
                  <input
                    ...
                    onChange={() =>
                      setProductoEdit({ ...productoEdit, unidad_medida: unidad })
                    }
                  />
                  {unidad}
                </label>
            ...
            <input
              ...
              onChange={(e) =>
                setProductoEdit({ ...productoEdit, costo_compra: e.target.value })
              }
              className="w-full border mb-2 px-3 py-2 rounded"
            />
            <input
              ...
              onChange={(e) =>
                setProductoEdit({ ...productoEdit, precio_venta: e.target.value })
              }
              className="w-full border mb-2 px-3 py-2 rounded"
            />
            ...
            <div className="mb-4">
              ...
              <label className="mr-4">
                <input
                  ...
                  name="estado"
                  value="1"
                  checked={productoEdit.estado === 1 || productoEdit.estado === "1"}
                  onChange={() =>
              ...
              <label>
                <input
                  ...
                  name="estado"
                  value="0"
                  checked={productoEdit.estado === 0 || productoEdit.estado === "0"}
                  onChange={() =>
